...
<body>
    <div class="body">
            <div class="login-section">
                ...
                <form method="post" id="edit-role" name="edit-role" action="./route.php?action=edit-role">
                    <div class="input-section"> <?php 
                    $result = mysqli_fetch_array($result);
                    ?>
                        <label>Role</label>
                        <input type="hidden" id="id" name="id" value="<?= $result["id_role"] ?>">
                        <input type="text" id="role" name="role" value="<?= $result["role"] ?>">
