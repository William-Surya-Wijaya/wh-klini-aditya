...
<body>
    ...
    <div class="title">Tambah User</div>
        <div class="tambah-section">
            <form  method="POST" name="tambah-form" id="tambah-form" action="./route.php?action=tambah-data">
...
<script>
    ...
    tambahButton.addEventListener('click', (event)=>{
      ...
      }else if(konfirmpassInput.value == ""){
        Swal.fire({
          icon: "error",
          title: "Oops...",
          text: "Please fill your confrim password",
          showConfirmButton: false,
          timer: 1500,
        });
      }else if(konfirmpassInput.value !== passwordInput.value){
        Swal.fire({
          icon: "error",
          title: "Oops...",
          text: "Match the password with the confirmation password",
          showConfirmButton: false,
          timer: 1500,
        });
      }else {
